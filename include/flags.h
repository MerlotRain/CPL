...
/// @tparam Enum
template<typename Enum>
class UTILITY_EXPORT GsEnumMaskFlag
{
...
template<typename Enum>
class UTILITY_EXPORT GsBitMaskFlag : public GsEnumMaskFlag<Enum>
{
...
public:
    ...
    virtual int Assign(const unsigned char *markData, int nLen)
    {
        ...
        nLen = Math::Min(nLen, MarkDataByteLength());
