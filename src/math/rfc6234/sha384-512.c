 ...
 */
#define SHA512_SHR(bits, word, ret) (/* (((uint64_t)((word))) >> (bits)) */                                                                                           \
                                     (ret)[0] = (((bits) < 32) && ((bits) >= 0)) ? ((word)[0] >> (bits)) : 0,                                                         \
                                     (ret)[1] = ((bits) > 32) ? ((word)[0] >> ((bits) -32)) : ((bits) == 32) ? (word)[0]                                              \
                                                                                      : ((bits) >= 0)        ? (((word)[0] << (32 - (bits))) | ((word)[1] >> (bits))) \
                                                                                                             : 0)

#define SHA512_SHL(bits, word, ret) (/* (((uint64_t)(word)) << (bits)) */                                                                                             \
                                     (ret)[0] = ((bits) > 32) ? ((word)[1] << ((bits) -32)) : ((bits) == 32) ? (word)[1]                                              \
