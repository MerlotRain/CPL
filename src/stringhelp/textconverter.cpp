...
{
    if (GS_STRCASECMP(srcEncoding, GsTextConverter::ENCODING_UCS2))
        srcEncoding = "UCS-2LE";
    else if (GS_STRCASECMP(srcEncoding, GsTextConverter::ENCODING_UTF16) &&
...
{
    if (GS_STRCASECMP(encoding, GsTextConverter::ENCODING_UTF8))
        return 1;
}
