...
String::String(const StlString &str) noexcept : StlString(str)
{
}

String::String(const char *str) noexcept : StlString(str)
{
}

String::String(char *str) noexcept : StlString(str)
{
}
...
String &String::Arg(const String &str, int width, char fill)
{
    return *this;
}

String &String::Arg(String &&str, int width, char fill)
{
    return *this;
}


String &String::Arg(short value, int base, int width, char fill, bool prefix)
{
...
String &String::Arg(unsigned short value, int base, int width, char fill, bool prefix)
{
    char result[MAX_INT_STRING_LENGHT];
    std::size_t sz = MAX_INT_STRING_LENGHT;
...
String &String::Arg(int value, int base, int width, char fill, bool prefix)
{
    char result[MAX_INT_STRING_LENGHT];
    std::size_t sz = MAX_INT_STRING_LENGHT;
    intToString(value, base, result, sz, prefix, width, fill);
...
String &String::Arg(unsigned int value, int base, int width, char fill, bool prefix)
{
    char result[MAX_INT_STRING_LENGHT];
    std::size_t sz = MAX_INT_STRING_LENGHT;
    unsignedIntToString(value, base, result, sz, prefix, width, fill);
...
String &String::Arg(long value, int base, int width, char fill, bool prefix)
{
    char result[MAX_INT_STRING_LENGHT];
    std::size_t sz = MAX_INT_STRING_LENGHT;
    intToString(value, base, result, sz, prefix, width, fill);
...
String &String::Arg(unsigned long value, int base, int width, char fill, bool prefix)
{
    char result[MAX_INT_STRING_LENGHT];
    std::size_t sz = MAX_INT_STRING_LENGHT;
    unsignedIntToString(value, base, result, sz, prefix, width, fill);
...
String &String::Arg(long long value, int base, int width, char fill, bool prefix)
{
    char result[MAX_INT_STRING_LENGHT];
    std::size_t sz = MAX_INT_STRING_LENGHT;
    intToString(value, base, result, sz, prefix, width, fill);
...
String &String::Arg(unsigned long long value, int base, int width, char fill, bool prefix)
{
    char result[MAX_INT_STRING_LENGHT];
    std::size_t sz = MAX_INT_STRING_LENGHT;
    unsignedIntToString(value, base, result, sz, prefix, width, fill);
...
String &String::Arg(float value, char format, int precision)
{
    char buffer[MAX_FLOAT_STRING_LENGTH];
    floatToString(buffer, MAX_FLOAT_STRING_LENGTH, value, precision);
    this->append(buffer);
...
String &String::Arg(double value, char format, int precision)
{
    char buffer[MAX_FLOAT_STRING_LENGTH];
    doubleToString(buffer, MAX_FLOAT_STRING_LENGTH, value, precision);
    this->append(buffer);
