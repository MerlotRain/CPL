...
{
    if (CRT::stricmp(srcEncoding, TextConverter::ENCODING_UCS2))
        srcEncoding = "UCS-2LE";
    else if (CRT::stricmp(srcEncoding, TextConverter::ENCODING_UTF16) &&
...
{
    if (CRT::stricmp(encoding, TextConverter::ENCODING_UTF8))
        return 1;
}
